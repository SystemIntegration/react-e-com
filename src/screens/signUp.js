...
function SignUp() {
    ...
    return (
        <div className="sign-up-page" style={{ textAlign: 'center', margin:'2rem 0' }}>
            <h2>Create an account</h2>
            <div>
                <form onSubmit={handleSubmit}>
                    <TextField  id="outlined-basic" label="Name" variant="outlined" value={name} onChange={(event) => setName(event.target.value)} className='rightTextField' />
                    ...
                    <TextField  id="outlined-basic" label="Password" variant="outlined" value={password}
                        onChange={(event) => setPassword(event.target.value)} className='rightTextField' />
                    ...
                    <TextField  id="outlined-basic" label="Address Line 1" variant="outlined" value={address1}
                        onChange={(event) => setAddress1(event.target.value)} className='rightTextField' />
                    ...
                    <TextField  id="outlined-basic" label="Address Line 3" variant="outlined" value={address3}
                        onChange={(event) => setAddress3(event.target.value)} className='rightTextField' />
